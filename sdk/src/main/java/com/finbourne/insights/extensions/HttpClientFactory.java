...
/**
* Builds http client to communicate to insights API instances.
*
*/
public class HttpClientFactory {
    ...
    *  calls to the insights API.
    *
    * @param apiConfiguration configuration to connect to insights API
    * @return an client for http calls to insights API
    */
     ...
     * @return n client for http calls to insights API
     */
